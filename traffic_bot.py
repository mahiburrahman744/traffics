...
proxy_url = "8d5b410c792e0999.abcproxy.vip:4950"
proxy_auth = "Kgr6lEXa6U-zone-star:57308329"
proxy = {
...
def send_request_and_render(url, playwright, retries=3):
    for attempt in range(retries):
        try:
            ...
            print(f"Page title: {page.title()}, Proxy: {proxy_url}, User-Agent: {user_agent}, Referrer: {referrer}")
            return page
